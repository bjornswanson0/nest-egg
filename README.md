...
- **Saved setups** — snapshot your whole configuration under a name and swap between setups from the results screen; stored on your device like everything else.
