...
- **Paystub converter** — copy the numbers off one paycheck (frequency, gross, net, 401(k), HSA) and it shows what they imply — annual income, true monthly take-home (payroll-deducted savings added back), 401(k) percentage, monthly HSA contribution — as ghost numbers on the matching questions, with the arithmetic on hover. Nothing is filled in for you.
